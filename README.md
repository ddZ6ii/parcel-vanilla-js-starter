# Parcel starter - HTML | CSS | Vanilla JS

This is a Parcel starter for vanilla JS projects. It is entented to be used together with `degit` to speed up the workflow of starting a new project from scratch.
